"""
Django settings for antenna_web project.
...
def get_secret(setting, secrets=secrets):
    try:
        ...
        error_msg = f"Set the {setting} envrionment variable"
...
WSGI_APPLICATION = 'antenna_web.wsgi.application'
